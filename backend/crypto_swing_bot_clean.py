...
MIN_ADX_STRENGTH = 25  # nÃ«n 25 = weak trend, shmang sinjale
...
def analyze_symbol(symbol: str):
    ...
    # 8) CRT (Change of Character)
    if crt_bull:
        buy_score += 1
        buy_details.append("CRT_BULL")
    if crt_bear:
        sell_score += 1
        sell_details.append("CRT_BEAR")
