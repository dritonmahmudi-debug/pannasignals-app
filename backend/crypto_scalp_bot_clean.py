...
SCAN_INTERVAL = 240  # 4 minuta (më pak skanime)
...
MIN_SCORE_FOR_SIGNAL = 5  # më strikt (ishte 4)
...
MIN_ADX_STRENGTH = 28  # më i lartë për trend më të fortë (ishte 25)
